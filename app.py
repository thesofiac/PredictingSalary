...
if menu == "Entenda os dados":
    ...
    st.markdown("<div style='text-align: justify'><h5>Os dados são referentes a vagas da área de dados e empresas avaliadas no <i>site</i> do Glassdoor. <br> Para cada uma das vagas, é possível obter: <br> - O Título da Vaga <br> - Sua Descrição <br> - Salário <span style='color:#E07A5F;'>Estimado</span> <br> - Nome, Setor e Avaliação da Empresa.</h5></div>", unsafe_allow_html=True)
    ...
    with col2:
        st.markdown("<h5>Os <span style='color:#E07A5F;'>Cientistas de Dados</span> são <br> os que recebem melhor, seguidos <br> dos <span style='color:#E07A5F;'>Engenheiros</span> e <span style='color:#E07A5F;'>Analistas</span> de Dados.</h5>", unsafe_allow_html=True)
