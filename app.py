...
if menu == "Entenda os dados":
    ...
    with col2:
        st.markdown("<h5>Os <span style='color:#E07A5F;'>Cientistas de Dados</span> são os que recebem melhor, <br>seguidos dos <span style='color:#E07A5F;'>Engenheiros</span> de Dados e <span style='color:#E07A5F;'>Analistas</span> de Dados.</h5>", unsafe_allow_html=True)
